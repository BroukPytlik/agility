...
class EventCalendar extends UI\Control {
    ...
    /**
     * moje proměnné předávané do šablony
     * @var \Nette\arrayHash
     */
...
/**
     * Předá parametr do šablony
     * @param \Nette\ArrayHash $options 
     */
    public function setTemplateVar(\Nette\ArrayHash $var) {
	...
	$this->template->var = $this->templateVar;
