/**
 * AJAX Nette Framework plugin for jQuery  1.2.0 (rijen 2012)
 *
 * @copyright Copyright (c) 2009, 2010 Jan Marek
 * @copyright Copyright (c) 2009, 2010 David Grudl
 * @copyright Copyright (c) 2012 Vojtěch Dobeš
 * @license MIT typeof c.debug!="undefined"?c.debug.apply(c,[e,h]):c.log.apply(c,[e,h])
 */
...
$.nette.ext('snippets', {
	...
	updateSnippet: function (id, html) {
		...
		//console.log(typeof $el.eq(0).tagName == "undefined");
		/*var guu=function(){
		    var guu=""; 
		    for(var k in $el){guu+=";\n  "+k}
		    return guu;
